...
namespace NeuralNetwork.Problems
{
    public static class HandwrittenDigits
    {
        public static void Run()
        {
            ...
            var dataset = File.ReadAllLines(@"C:\Users\bogda\source\repos\NeuralNetwork\NeuralNetwork\train.txt");
            ...
            var queryDataset = File.ReadAllLines(@"C:\Users\bogda\source\repos\NeuralNetwork\NeuralNetwork\train.txt"); ;
