...
namespace NeuralNetwork.Problems
{
    public static class XOR
    {
        public static void Run()
        {
            ...
            {
                network.Train(new[] { 0.0000001, 0.00000000001 }, new[] { 0.00000001 });
                network.Train(new[] { 0.00000001, 0.999999999 }, new[] { 0.99999999 });
                network.Train(new[] { 0.9999999999, 0.00000000001 }, new[] { 0.999999 });
                network.Train(new[] { 0.9999999999, 0.9999999999999 }, new[] { 0.00000000001 });
            }
